...
func (s *AsteriskService) GetInfo() (*AsteriskInfo, error) {
	...
	if _, err := s.client.Get("/asterisk/info", nil, &ai, nil); err != nil {
		return nil, err
	}
	return &ai, nil
}
...
func (s *AsteriskService) GetGlobalVar(variable string) (string, error) {
	...
	if _, err := s.client.Get("/asterisk/variable", &napping.Params{"variable": variable}, &out, nil); err != nil {
		return "", err
	}
...
func (s *AsteriskService) SetGlobalVar(variable, value string) error {
	...
	if _, err := s.client.Post("/asterisk/variable", payload, nil, nil); err != nil {
		return err
	}
	return nil
}
